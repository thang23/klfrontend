...
import { CreateLocation } from '../../../services/Admin/location';
import { getAddressFromCoordinates, getCoordinates } from '../../../services/geocodingUtils';

// Tải Goong Map CSS và JS

import goongJs, * as goongjs from '@goongmaps/goong-js';
import { getCategory } from '../../../services/Admin/Categories';

const ModalCreateLocation = ({ show, handleClose, onEditSuccess }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        price: '',
        description: '',
        latitude: '16.4619', // Mặc định tọa độ Huế
        longitude: '107.5955',
        difficultyLevel: '',
        categoryId: ''
    });
    ...
    useEffect(() => {
        if (show && mapContainerRef.current && !mapRef.current) {
            ...
            mapRef.current = new goongjs.Map({
                ...
                center: [parseFloat(formData.longitude) || 107.5955, parseFloat(formData.latitude) || 16.4619],
                zoom: 15,
            });
            ...
            markerRef.current = new goongjs.Marker({
                ...
                .setLngLat([parseFloat(formData.longitude) || 107.5955, parseFloat(formData.latitude) || 16.4619])
    ...
    useEffect(() => {
        // Cập nhật vị trí marker và bản đồ khi formData thay đổi
    ...
    const handleSubmit = async () => {
        ...
        if (!formData.latitude || !formData.longitude) {
            toast.error('Vui lòng đảm bảo địa chỉ hợp lệ để lấy tọa độ hoặc kéo thả marker trên bản đồ!');
            return;
        }
    ...
    return (
        <Modal show={show} onHide={handleClose} size="lg">
            <Modal.Header closeButton>
                <Modal.Title>Tạo địa điểm</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <form>
